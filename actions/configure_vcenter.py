...
class ConfigureVcenter(Action):
    ...
    def run(self, host=None, username=None, password=None, vcenter_name=None, vcenter_url=None,
            vcenter_user=None, vcenter_pass=None):
        ...
        with pynos.device.Device(conn=conn, auth=auth) as device:
            ...
            if changes['pre_requisites']:
                changes['configure_vcenter'] = self._configure_vcenter(device, vcenter_name,
    ...
    def _create_vcenter(self, device, vcenter_name, vcenter_url, vcenter_user, vcenter_pass):
        ...
        """
        try:
            device.vcenter.add_vcenter(id=vcenter_name, url=vcenter_url, username=vcenter_user,
